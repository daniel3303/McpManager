...
namespace McpManager.Core.Data.Migrations
{
    ...
    public partial class AddNamespaces : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    McpConnectionTimeoutSeconds = table.Column<int>(
                        type: "INTEGER",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RateLimitRequestsPerMinute = table.Column<int>(
                        type: "INTEGER",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameOverride = table.Column<string>(
                        type: "TEXT",
                        maxLength: 255,
                        nullable: true
                    ),
                    DescriptionOverride = table.Column<string>(
                        type: "TEXT",
                        maxLength: 2000,
                        nullable: true
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "ApiKeyNamespaces");

            migrationBuilder.DropTable(name: "AppSettings");

            migrationBuilder.DropTable(name: "McpNamespaceTools");

            migrationBuilder.DropTable(name: "McpNamespaceServers");

            migrationBuilder.DropTable(name: "McpNamespaces");
            ...
            migrationBuilder.DropColumn(name: "McpNamespaceId", table: "McpToolRequests");
